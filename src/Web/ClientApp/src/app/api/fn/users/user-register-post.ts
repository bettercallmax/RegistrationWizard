...
export function userRegisterPost(http: HttpClient, rootUrl: string, params?: UserRegisterPost$Params, context?: HttpContext): Observable<StrictHttpResponse<UserModel>> {
